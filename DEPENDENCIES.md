...
| dexie | https://dexie.org | https://github.com/dexie/Dexie.js.git | A Minimalistic Wrapper for IndexedDB | ^4.0.11 | 4.3.0 | ✅ | 3.09MB |
| dexie-react-hooks | https://dexie.org | https://github.com/dexie/Dexie.js.git | React hooks for reactive data fetching using Dexie.js | ^1.1.7 | 4.2.0 | ✅ | 103.30KB |
| firebase | https://firebase.google.com/ | https://github.com/firebase/firebase-js-sdk.git | Firebase JavaScript library for web and Node.js | ^10.14.1 | 12.9.0 | ✅ | 30.94MB |
| firebase-admin | https://firebase.google.com/ | https://github.com/firebase/firebase-admin-node.git | Firebase admin SDK for Node.js | ^13.3.0 | 13.6.1 | ✅ | 1.39MB |
...
| nuqs | https://nuqs.dev | https://github.com/47ng/nuqs.git | Type-safe search params state manager for React - Like useState, but stored in the URL query string | ^2.4.3 | 2.8.8 | ✅ | 429.64KB |
...
| react | https://react.dev/ | https://github.com/facebook/react.git | React is a JavaScript library for building user interfaces. | 19.2.4 | 19.2.4 | ❌ | 171.60KB |
| react-dom | https://react.dev/ | https://github.com/facebook/react.git | React package for working with the DOM. | 19.2.4 | 19.2.4 | ❌ | 7.32MB |
...
| zustand | https://github.com/pmndrs/zustand | https://github.com/pmndrs/zustand.git | 🐻 Bear necessities for state management in React | ^5.0.3 | 5.0.11 | ✅ | 95.00KB |
...
| @types/node | https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/node | N/A | TypeScript definitions for node | ^20.17.19 | 25.2.3 | ✅ | 2.37MB |
