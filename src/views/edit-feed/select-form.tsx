...
import type { ZFeedByID, ZFeedChannel } from "~/entities/feeds/models";
...
export default function SelectForm({
  ...
  const handleAddChannel = async () => {
    ...
    const channelDetails: ZFeedChannel = {
  ...
  const handleBrowsePlaylists = async () => {
    ...
    if (channelExists) {
      toast(
        `${channelInfo.channelTitle}'s channel is already added to the feed.`,
        {
          description:
